...
/*if(){
  for(let i = 0; i < optionList.length; i++){
      optionList[i].addEventListener('click', () => {
        if(optionList[i] == 4 || optionList[i] == 5||optionList[i] == 6||optionList[i] == 7){
          sidebar.classList.remove('show-sidebar');
...
optionList[4].addEventListener('click', () => {
  sidebar.classList.remove('show-sidebar');
  console.log(optionList);
});
optionList[5].addEventListener('click', () => {
  sidebar.classList.remove('show-sidebar');
  console.log(optionList);
});
optionList[6].addEventListener('click', () => {
  sidebar.classList.remove('show-sidebar');
  console.log(optionList);
});
optionList[7].addEventListener('click', () => {
  sidebar.classList.remove('show-sidebar');
  console.log(optionList);
});
