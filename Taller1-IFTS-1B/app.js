...
const getInputFormName = () =>{
  let inputFormName = document.getElementById('name').value;
  //document.getElementById('inputFormName') = inputFormName;
}

const getInputFormNumber = () =>{
  let inputFormNumber = document.getElementById('number').value;
  console.log(inputFormNumber);
//  document.getElementById('inputFormNumber').innerHTML = inputFormNumber;
}

inputFormBTNsubmit.addEventListener('click', () => {
    result.innerHTML = `reason: ${getInputFormName()}  $${getInputFormNumber()}`;
});
